...
class NCBIRetriever:
    ...
    def search_taxid(self, taxid, min_seq, max_seq):
...
def main():
    ...
    min_seq = input("Enter min sequence length: ")
    max_seq = input("Enter max sequence length: ")

    # Szukaj rekordów
    count = retriever.search_taxid(taxid, min_seq, max_seq)
